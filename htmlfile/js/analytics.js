(function () {
    ...
    var ed = S("_j1", "jid"), Cd = S("_j2", "gjid");
    cb("\\&(.*)", function (a) {
        ...
        b[a] = function () {
            try {
                ...
                if (!(1 <= 100 * n.random() || xa("?"))) {
                    var ca = ["t=error", "_e=exc", "_v=j21", "sr=1"];
                    a && ca[p]("_f=" + a);
    ...
    var Jd = function (a, b, c, d) {
        ...
        var g = a.get(Wb);
        a.set(Wb, function (a) {
            a.get(e.U) || ("1" == ya(e.Y)[0] ? a.set(e.U, "", !0) : a.set(e.U, "" + hd(), !0));
            var b = g(a);
            a.get(e.U) && zc(e.Y, "1", a.get(Yb), a.get(W), a.get(Na), 6E5);
            return b
        });
        var ca = a.get(Xb);
        a.set(Xb, function (a) {
        ...
        if (b.get(a.U)) {
            ...
            d(a.U);
            var e = a.aa;
            "/" === e[Cc](0) && (e = (R(b, "forceSSL") || "https:" == M[B][E] ?
                "https:" : "http:") + e);
            c.map(function (a, b) {
                e += sa(a) + "=" + sa("" + b) + "&"
            });
    ...
    var fd = function (a, b) {
        ...
        if (!c.get("dcLoaded")) {
            ...
            var d;
            b[U] && (d = ka(b[U]));
            new Jd(c, ed, "//stats.g.doubleclick.net/collect?t=dc&aip=1&", d);
            c.set("dcLoaded", !0)
        }
    };
    var Kd = function (a, b) {
        ...
        if (!c.get("rlsaLoaded")) {
            ...
            var d;
            b[U] && (d = ka(b[U]));
            new Jd(c, Cd, "https://www.google.com/ads/ga-audiences?t=sr&aip=1&", d);
            c.set("rlsaLoaded", !0);
    ...
    var pc = function (a) {
        ...
        a.get(Q) || ((c = (c = O.gaGlobal && O.gaGlobal.vid) &&
            -1 != c[ga](/^(?:utma\.)?\d+\.\d+$/) ? c : void 0) ? (J(17), a[q].set(Q, c)) : (J(8), a[q].set(Q, [hd() ^ Mc() & 2147483647, n.round((new Date)[da]() / 1E3)][H]("."))));
        mc(a)
    }, Kc = function (a) {
        ...
        c && c[la] && c[na] && ("CSS1Compat" === M.compatMode || !g) ? ca = [c[la],
            c[na]] : g && (ca = [e[la], e[na]]);
        ...
        if (d && a.get(cc) && (b = M[B][h])) {
            b = b[A](/[?&#]+/);
            d = [];
            for (c = 0; c < b[y]; ++c)(ea(b[c], "utm_id") || ea(b[c], "utm_campaign") || ea(b[c], "utm_source") || ea(b[c], "utm_medium") || ea(b[c], "utm_term") || ea(b[c], "utm_content") || ea(b[c], "gclid") || ea(b[c], "dclid") || ea(b[c],
                "gclsrc")) && d[p](b[c]);
